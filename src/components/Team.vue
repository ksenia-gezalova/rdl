...
export default {
  ...
  data() {
    return {
      list: [
        new Card("Евгений Крекотень", "photos/1.jpg", "Генеральный директор"),
        new Card("Анастасия Кузнецова", "photos/2.jpg", "Финансовый директор"),
        new Card(
          "Вячеслав Климов",
          "photos/3.jpg",
          "Заместитель генерального директора"
        ),
        new Card("Юрий Лаврухин", "photos/4.jpg", "Директор по продажам"),
        new Card("Вадим Степанов", "photos/5.jpg", "Директор проектов"),
        new Card(
          "Александр Шинов",
          "photos/6.jpg",
